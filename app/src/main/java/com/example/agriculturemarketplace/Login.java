...
import com.example.agriculturemarketplace.databinding.ActivityLoginBinding;
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (user != null) {
                                        ...
                                        My_Model userModel = new My_Model(name, email, "", userId); // Set an empty password or handle it appropriately
